...
public class C4DeploymentView extends C4View {
    ...
    @Builder
    public C4DeploymentView(String key, String name, String description, Set<C4Tag> tags, Set<C4Reference> elements, C4Reference system, String environment, Set<C4Reference> relationships) {
