...
public class ArchitectureDataStructureWriterTest {
    ...
    public void shouldWriteDocumentationImagesToDocumentationDirectory() throws Exception {
        ...
        // Then
        Path imagePath = rootDir.resolve("documentation").resolve("thoughtworks.png");
        byte[] actual = Files.readAllBytes(imagePath);
        byte[] expected = Files.readAllBytes(Path.of(getClass().getResource(TestHelper.IMAGE_THOUGHTWORKS_FILE).getPath()));
